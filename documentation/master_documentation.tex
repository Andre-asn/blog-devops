...
\newcommand{\COMMITHASH}{7d9a664}
\newcommand{\COMMITDATE}{2025-12-07 18:47:04 -0500}
\newcommand{\COMMITAUTHOR}{Andre Santiago-Neyra}
\newcommand{\COMMITMESSAGE}{docs: Refactor documentation paths and update scripts for consistency}
