...
echo "🚀 Setting up DigitalOcean Droplet 1 for GitHub Actions deployment..."
...
# Install MongoDB exporter (optional but recommended)
...
echo "✅ Droplet 1 setup complete!"
echo "📝 Next steps:"
echo "1. Update .env file with actual values"
echo "2. Add SSH key to GitHub repository secrets as DIGITALOCEAN_SSH_KEY"
echo "3. Add droplet IP to GitHub secrets as DIGITALOCEAN_HOST"
echo "4. Add username to GitHub secrets as DIGITALOCEAN_USER"
echo "5. Add app directory to GitHub secrets as APP_DIRECTORY (/var/www/blog-app)"
echo "6. Update monitoring/prometheus.yml with this droplet's IP"
